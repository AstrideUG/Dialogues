 ...
 */
var dialogues: MutableMap<Int, MutableList<Dialogue>> = mutableMapOf() //EntityID, all dialogues
 ...
 */
var states: MutableMap<UUID, MutableMap<Int, String>> = mutableMapOf() //(Player)UUID, <EntityID, DialogueID>
